...
def predict_for_file(input_file, output_file, model, batch_size=32):
    ...
    for sent in test_data:
        ...
        if len(batch) == batch_size:
            preds, cnt = model.handle_batch(batch) # xuyao xiugai !!!!!!!!
...
def main(args):
    # get all paths
    args.transformer_model='hfl/chinese-xlnet-base'
...
if __name__ == '__main__':
    ...
    # ---------下面这2个是我改进后的配置
    args.model_path=['tmpModel2zh/model.th']  # 需要传入数组.
    args.vocab_path='tmpModel2zh/vocabulary'
    ...
    args.input_file='wi_loc_src.txt'
    args.output_file='2outzh'
    main(args)
    '''
